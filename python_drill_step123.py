...
# move from GUI
        ...
        self.lblFrom = Label(self.master, text='Move From: ', font=("Arial", 16), fg='black', bg='beige')
        self.lblFrom.grid(row=0, column=0, padx=(30, 0), pady=(30, 0))

        self.txtInputFrom = Entry(self.master, text=self.varInputFrom, font=("Arial", 12), fg='black', bg='white')
...
# move to GUI
        ...
        self.txtInputTo = Entry(self.master, text=self.varInputTo, font=("Arial", 12), fg='black', bg='white')
        self.txtInputTo.grid(row =2, column=1, padx=(0, 0), pady=(0, 0), columnspan=6)

        self.lblTo = Label(self.master, text='Move To: ', font=("Arial", 16), fg='black', bg='beige')
...
# database
    ...
    def Database_create():
        conn = sqlite3.connect('python_drill.db')
        with conn:
            cursor = conn.cursor()
